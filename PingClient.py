...
def startConenection(connectionInfo):
    '''
    :param connectionInfo: object that holds all the info of the connection
    :type connectionInfo: Connection
    :return: TCP/UDP socket
    '''
...
def calcStatistics(connectionInfo, packetsRecv):
    ...
    :param connectionInfo: object that holds all the info of the connection
    :type connectionInfo: Connection
    :param packetsRecv: the number of packet successfully received from the server
    :type packetsRecv: int
    :return: None
    '''
